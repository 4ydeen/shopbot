...
const SETTINGS_GROUPS = [
  ...
  { tab: 'payment', title: '⭐ NoapayBot (خرید استارز تلگرام، تایید آنی)', fields: [
    { key: 'noapay_payment_enabled', label: 'فعال بودن درگاه NoapayBot', type: 'bool' },
    { key: 'noapay_api_key', label: 'کلید API', type: 'password' },
    { key: 'noapay_webhook_secret', label: 'رمز وب‌هوک', type: 'password' },
    { key: 'noapay_rate_toman_per_star', label: 'نرخ تقریبی تومان به‌ازای هر استارز', type: 'number' },
  ]},
